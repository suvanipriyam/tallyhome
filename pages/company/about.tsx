  ...
  <div className="card">
    ...
    >
      <div className="card-header1">
        <h6 className="mb-0">
          <a href="Accounting-glowips-delhi.php" className="collapsed">
            Accounting
          </a>
        </h6>
      </div>
      ...
      <div className="card-header1">
        <h6 className="mb-0">
          <a href="Costing-tallyerp-9-glowips-delhi.php" className="collapsed">
            Costing{" "}
          </a>
        </h6>
      </div>
      ...
      <div className="card-header1">
        <h6 className="mb-0">
          <a href="Payroll-tallyerp-9-glowips-delhi.php" className="collapsed">
            Payroll{" "}
          </a>
        </h6>
      </div>
    ...
    >
      <div className="card-header1">
        <h6 className="mb-0">
          <a href="Upgrades-Migration-glowips.php" className="collapsed">
          ...
          <div className="col-lg-12 col-md-12">
            <div className="section-title">
              ...
              <p className="text-justify pt-3 pb-3">
                ...
                Developers , SAP integrators , Tally Certified Professionals ,
                Management Analyst's , BDM , Corporate Trainers , Sales and
                Admin Professionals , And Network Engineers.
              </p>
              <p className="text-justify pt-3 pb-3">
                We believe in the simple mechanism of 'Righteous Business' and
                are developing our Goodwill through Team efforts , Assured
                Solutions , Dignity , Quality , On-Time Implementation ,
                Procedural Management , Self Belief &amp; reliance and Fair
                Business Practises.
              </p>
              <p className="text-justify pt-3 pb-3">

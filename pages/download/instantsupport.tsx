      ...
      <div className="col-lg-8 col-md-8">
        <div className="section-title">
          ...
          <p>
            ...
            controlling and other constrains. It is therefore unworkable to have
            a complete ERP solution. Tally provides accounting, HR , Taxation ,
            Production and Manufacturing ; but still a deficient gap between the
            actual standards set by the org arises Therefore, customizations are
            an integral part of all accounting software's.
          </p>
          <p>
            Tally ERP-9 is customizable to a very large extent. We have clients
            those who prefer shifting from SAP , Busy , etc to Tally due to the
            user-friendly accounting strategies and customizable standards .
          </p>
          <p>
            Our Development Team in Delhi , caters developing assignment and is
            capable to provide distinctive solutions in Tally Software like
            developing complete CRM , Manufacturing Modules , Jewellery Advanced
            Projects according to the industry requirement .
          </p>
          <p>
            In our strategic analysis, we study the organizational requirement
            with our development Team. Only after a thorough study and assuming
            the feasibility of the project according to software
            compatibilities, we consider and commence work.
          </p>
          <p>
            Custom built Solutions can enhance any accounting structure, as the
            work is completed as per the requirement of the organization ; and
            the customization would be done to target the central part of the
            work.{" "}
          </p>
        </div>
      </div>

      ...
      <div className="col-lg-8 col-md-8">
        <div className="section-title">
          ...
          <p className="p-3">
            ...
            'shop' at a customer location or a free lancer developing extensions
            to Tally.ERP 9, we make available Tally.Developer 9, an Integrated
            Development Environment (IDE) along with the full TDL source code.
          </p>
          <p className="p-3">
          ...
          <div className="row">
            <div className="col-md-12 col-12">
              <div className="client-border-2 mt-3 mb-3">
                ...
                <p className="p-3">
                  TDL is a language based on definitions. A definition language
                  provides the users with 'Definitions' that can be used to
                  specify the task to be performed. It is possible to reuse the
                  existing definitions and deploy applications quickly. This is
                  a language meant for rapid development. It is possible to
                  develop complex reports within minutes. User can extend the
                  default functionalities of the product by writing only a few
                  lines of code.
                </p>
              </div>
            </div>
            <div className="col-md-12 col-12">
              <div className="client-border-2 mt-3 mb-3">
                <div className="client-heading">
                  <p>Action Driven Language with Procedural Capabilities</p>
                </div>
                <p className="p-3">
                  TDL is an Action Driven language where the programmer can only
                  control as to what happens when a particular event takes
                  place. The action thus triggered can either be a platform
                  defined action or an Action created by TDL programmer using
                  User Defined Functions. The fundamental aspects of conditional
                  evaluation and looping have been introduced into the language.
                  The non-procedural elements are largely towards presentation
                  layers and data gathering. The procedural elements can be used
                  for flow control, computation and object data manipulation.
                </p>
              </div>
            </div>
            <div className="col-md-12 col-12">
              <div className="client-border-2 mt-3 mb-3">
                ...
                <p className="p-3">
                  Using the same language it is possible to output to multiple
                  output devices and formats .Whenever an output is generated
                  this can be displayed on the screen, printed ,transferred to a
                  file in particular format, mailed or transferred to a webpage
                  using Http protocol.
                </p>
              </div>
            </div>
            <div className="col-md-12 col-12">
              <div className="client-border-2 mt-3 mb-3">
                ...
                <p className="p-3">
                  Tally follows a hierarchical object oriented data structure.
                  TDL provides the capability of creating and manipulating these
                  objects with ease. Apart from the predefined objects user can
                  also store and manipulate data as required by him.
                </p>
              </div>
            </div>
            <div className="col-md-12 col-12">
              <div className="client-border-2 mt-3 mb-3">
                ...
                <p className="p-3">
                  To meet the challenges of business environment it becomes
                  absolutely mandatory to share information seamlessly across
                  applications. Integration becomes a crucial factor in avoiding
                  the duplication of data entry. The available Tally API's ODBC,
                  XML and DLL allow integration between
                </p>
                <p className="p-3">Tally to Tally using Synchronisation</p>
                <p className="p-3">
                  Tally to External Application and vice versa using the
                  Interfaces Available
                </p>
                <p className="p-3">Tally to Web Service using HTTP Interface</p>
                <p className="p-3">

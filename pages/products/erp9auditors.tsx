    ...
    <div className="row justify-content-center flex-flow-row-reverse">
      ...
      <div className="col-lg-8 col-md-8">
        <div className="section-title">
          ...
          <p className="p-3">
            Available exclusively for practicing Chartered Accountants, this
            edition comes will all the advantages of the Gold edition and with
            several extras!
          </p>
          <div className="row">
            <div className="col-md-12 col-12">
              <div className="client-border-2 mt-3 mb-3">
                <div className="client-heading">
                  <p>
                    These extra features are not available to Silver &amp; Gold
                    users:
                  </p>
                </div>
                ...
                <p className="p-3">
                  ...
                  flagged as 'potentially incorrect' with an indication of what
                  that error could be. Send your clients these exception reports
                  &amp; get their clarifications
                </p>
                <p className="p-3">
                  Scrutinise records as per type of audit or compliance you are
                  undertaking (focused audit)
                </p>
                <p className="p-3">
                  Filter out transactions you want to physically audit (for
                  random audit)
                </p>
                <p className="p-3">
                  Generate annexure for Section 44AB; Form 3CD Annexure Clause
                  16, Clause 17(h), Clause 21, Clause 24(a &amp; b), Annexure II
                  &amp; Clause 27
                </p>
                <p className="p-3">
            ...
            <div className="col-md-12 col-12">
              <div className="client-border-2 mt-3 mb-3">
                ...
                <p className="p-3">
                  Overcome the shortage of article clerks by utilising existing
                  resources better{" "}
                </p>
                <p className="p-3">
                  Provide instant assistance &amp; training to your article
                  clerks{" "}
                </p>
                <p className="p-3">Monitor the quality of their work </p>
                <p className="p-3">Save on travel time and costs </p>
                <p className="p-3">
                  Help clients file various tax returns by verifying documents
                  quickly{" "}
                </p>
              </div>
            </div>
            <div className="col-md-12 col-12">
              <div className="client-border-2 mt-3 mb-3">
                ...
                <p className="p-3">
                  Example your client has given access permission to you for
                  audit and other purposes. You wish to assign this company to
                  an article clerk who has been assigned a separate Tally.NET
                  identity. Now your client need not give additional permissions
                  to your article clerk – you can make this assignment yourself
                  – making it easy to manage different articles as well as
                  manage hires and exits easily
                </p>
                <p className="p-3">
                  If you actually visit the clients location and log in with
                  your identity - all Auditors' Edition features will be
                  automatically available at this location as well - meaning
                  that Remote Access is not always needed
                </p>
                <p className="p-3">
                  You can login to your system or a clients system from an
                  educational version of Tally.ERP 9 (from anywhere) or even
                  from a regular Silver or Gold edition - you will get access to
                  all Auditors' Edition features
                </p>
              </div>
            </div>
          </div>

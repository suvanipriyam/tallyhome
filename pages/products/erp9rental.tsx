    ...
    <div className="row justify-content-center flex-flow-row-reverse">
      ...
      <div className="col-lg-8 col-md-8">
        <div className="section-title">
          ...
          <p className="p-3">
            With over 90% (estimated) businesses in India using Tally.ERP 9 (and
            earlier versions), there falls on us a tremendous responsibility to
            further ease the availability. Your feedback has reached us - We
            hear you!
          </p>
          <p className="p-3">
            Tally.ERP 9 is now available in a rental model. Simply put, you can
            now pay per quarter or even per month of use.
          </p>
          <p className="p-3">
            At 10% per quarter (around 3% per month) we believe that with this
            model, all your general and special needs have been addressed:
          </p>
          <p className="p-3">
            If you are presently operating in an environment where Capital
            Expenses are constrained - the rental model offers you the freedom
            to operate in an Operating Expenses mode.
          </p>
          <div className="row">
            <div className="col-md-12 col-12">
              <div className="client-border-2 mt-3 mb-3">
                <div className="client-heading">
                  <p>
                    There is sometimes the need for an additional license for
                    short term use:
                  </p>
                </div>
                <p className="p-3">
                ...
                <p className="p-3">An off-site festival/promotional sale</p>
              </div>
            </div>
            <div className="col-md-12 col-12">
              <div className="client-border-2 mt-3 mb-3">
                ...
                <p className="p-3">
                  During audits or unanticipated peak loads, you can rent a
                  Silver or Gold edition while your regular work continues as
                  usual
                </p>
                <p className="p-3">
                  During initial implementation such additional rental licenses
                  can be used to punch in old entries, while you take full
                  advantage of Tally.ERP 9 from day one for current business
                  operations
                </p>
              </div>
            </div>
            <div className="col-md-12 col-12">
              <div className="client-border-2 mt-3 mb-3">
                <div className="client-heading">
                  <p>
                    As a Tally education partner, rental opens up a new world of
                    convenience:
                  </p>
                </div>
                <p className="p-3">
                  With government and NGO thrust on vocational training programs
                  to help making people employment-ready, the demand for
                  Tally.ERP 9 training at hundreds or small locations in
                  growing. With the rental program, you can easily rent
                  Tally.ERP 9 for the duration of the training programs and
                  build the cost into operating expenses. There is no need to
                  carry the cost of hundreds of Tally.ERP 9 licenses
                </p>
              </div>
            </div>
            <div className="col-md-12 col-12">
              <div className="client-border-2 mt-3 mb-3">
                ...
                <p className="p-3">
                  You can carry options for business ready PC's with Tally.ERP 9
                  pre-loaded
                </p>
              </div>
            </div>
            <div className="col-md-12 col-12">
              <div className="client-border-2 mt-3 mb-3">
                ...
                <p className="p-3">
                  Offer your business buyers a great experience - with TallyERP
                  9 available out of the box, at a low start up cost to you and
                  to your customer
                </p>
                <p className="p-3">
                  Clubbed with an extremely simple process to acquire a rental
                  license, renew or move to a regular perpetual license,
                  Tally.ERP 9 - Rental offers everyone a great experience.
                </p>
              </div>
            </div>
          </div>

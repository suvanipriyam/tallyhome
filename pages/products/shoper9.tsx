          ...
          <div className="row">
            <div className="col-md-12 col-12">
              <div className="client-border-2 mt-3 mb-3">
                ...
                <p className="p-3">
                  As technology evolves, businesses like yours have to keep in
                  step for sustainable results. Staying aligned with customer
                  needs at the same time is often a challenge. Shoper 9 is
                  designed to handle lakhs of SKUs (items), thousands of
                  transactions per day and even support hundreds of stores in a
                  chain. So the modern retail business gets to leverage its core
                  strengths. Combining unmatched retail expertise and a rich
                  development, Shoper 9 represents the best of breed.
                </p>
                <p className="p-3">
                  If it's better control of promotions, merchandising, or even a
                  stock query that helps customers check on which of your
                  outlets stocks a particular product, Shoper 9 is up to the
                  task. This retail management software product convincingly
                  addresses pain points such as data exchange between head
                  office, warehouses and stores, providing a robust interface.
                  Favoured by leading Indian specialty stores, Shoper 9 has
                  catered to the apparel, footwear and textile segments with
                  tremendous success.
                </p>
                <p className="p-3">
                  The Shoper 9 philosophy is ease of use. And there's a tested
                  support system in place to ensure its smooth functioning.
                  Professional support for Shoper 9 comes from the Tally
                  Integrators and via Tally Service Partners.
                </p>
              </div>
            </div>
          </div>

    ...
    <div className="row justify-content-center flex-flow-row-reverse">
      ...
      <div className="col-lg-8 col-md-8">
        <div className="section-title">
          ...
          <p>
            Our Technical Team provides complete solutions for your organization
            working on Tally Systems and other software's. We have tools and
            means of migrating data from other software's to Tally ERP-9 or any
            other release.
          </p>
          <div className="row">
                ...
                <div className="row justify-content-center align-items-center">
                  <div className="col-md-12">
                    <ul className="ms-5">
                      ...
                      <li>BUSY</li>
                      <li>
                        Previous Tally Versions 4, 4.5, 4.6, 5.4, 6.3, 7.2, 8.1,
                        9.0
                      </li>
                ...
                <div className="row justify-content-center align-items-center">
                  <div className="col-md-12">
                    <table width="100%" className="p-2">
                      <tbody>
                        <tr>
                          <td className="p-2">Tally 9 Gold to ERP-9 Gold</td>

    ...
    <div className="row justify-content-center flex-flow-row-reverse">
      ...
      <div className="col-lg-8 col-md-8">
        <div className="section-title">
          ...
          <p className="p-3">
            We understand the problems in the cities and the expenses incurred
            by candidates / students by commuting from one place to another,
            which involves unnecessary travelling expenses and other health
            related issues.
          </p>
          <p className="p-3">
            To cover the gaps in their efforts to reach our academy, our team of
            Professionals will reach their sites for much convenience and
            flexibility in time selection. We require sincere candidates those
            who are willing to be Tally ERP-9 experts and their willingness to
            learn the technical trainings, live projects by our Team members.
            Our Unit provides Placements assistance to all willing and genuine
            candidates.
          </p>
          <div className="row justify-content-center">
            <div className="col-md-12 col-12">
              <div className="client-border-2 mt-3 mb-3">
                ...
                <p className="p-3">
                  Installation and configuration of Tally products to suit your
            ...
            <div className="col-md-12 col-12">
              <div className="client-border-2 mt-3 mb-3">
                ...
                <p className="p-3">
                  Import data from old versions or from other applications.
                  Having data on legacy systems is no more a reason to worry!
                  Further our partners will help you export data from our
                  products to other business solutions easily and effectively.
                </p>
              </div>
            </div>
            <div className="col-md-12 col-12">
              <div className="client-border-2 mt-3 mb-3">
                ...
                <p className="p-3">
                  We help in setting up synchronisation of data between various
                  offices across geographical locations to your head office.
                </p>
              </div>
            </div>
            <div className="col-md-12 col-12">
              <div className="client-border-2 mt-3 mb-3">
                ...
                <p className="p-3">
                  Require your staff to be trained for efficient use of our
                  products? We will be glad to discuss your requirements,
                  customise a relevant training program and conduct this
                  on-site!{" "}
                </p>
              </div>
            </div>

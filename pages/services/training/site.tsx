      ...
      <div className="col-lg-8 col-md-8">
        <div className="section-title">
          ...
          <p className="p-3">
            ...
            professional reach them. Our Strong workforce of Tally Professionals
            will reach any willing candidate in Delhi – NCR , to enroll in Tally
            ERP-9 courses.
          </p>
          <p className="p-3">
          ...
          <div className="row">
            <div className="col-md-12 col-12">
              <div className="client-border-2 mt-3 mb-3">
                ...
                <p className="p-3">I.Using &amp; Working with Customizations</p>
                <p className="p-3">
                  J.Special Projects for CA's and Corporate at our site.
                </p>
                <p className="p-3">
                  The training at site is provided at justified genuine quotes
                  and can be considered for special cases.
                </p>
              </div>
            </div>
          </div>

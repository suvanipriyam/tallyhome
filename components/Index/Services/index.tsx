          ...
          <div className="row">
            ...
            <div className="col-md-3 col-lg-3 service-item">
              <div className="service-top-svg">
                <svg className="front" viewBox="0 0 180 320" preserveAspectRatio="none">
                ...
                <svg className="back" viewBox="0 0 180 320" preserveAspectRatio="none">
                ...
                <div className="service-content-item">
                  ...
                  <p>
                    FOR MAKING TALLY SOFTWARE,
                    TAILORMADE,
                    TO SUIT YOUR ENTERPRISE NEED.</p>
                </div>
                <div className="service-content-item2">
                  <h5 > Office
                    <a> Implementation Unit</a> </h5>
                </div>
                <img src="https://www.tallysolution.net/assets/images/1.png" alt="Tally Customization in Delhi India" />
              </div>
            </div>
            <div className="col-md-3 col-lg-3 service-item">
              <div className="service-top-svg">
                ...
                <img src="https://www.tallysolution.net/assets/images/2.png" alt="Tally Customization in Delhi India" />
              </div>
            </div>
            <div className="col-md-3 col-lg-3 service-item">
              <div className="service-top-svg">
                ...
                <img src="https://www.tallysolution.net/assets/images/3.png" alt="Tally Customization in Delhi India" />
              </div>
            </div>
            <div className="col-md-3 col-lg-3 service-item">
              <div className="service-top-svg">
                ...
                <img src="https://www.tallysolution.net/assets/images/4.png" alt="Tally Customization in Delhi India" />
              </div>
            </div>
            <div className="col-md-3 col-lg-3 service-item">
              <div className="service-top-svg">
                ...
                <img src="https://www.tallysolution.net/assets/images/5.png" alt="Tally Customization in Delhi India" />
              </div>
            </div>
            <div className="col-md-3 col-lg-3 service-item">
              <div className="service-top-svg">
                ...
                <img src="https://www.tallysolution.net/assets/images/6.png" alt="Tally Customization in Delhi India" />
              </div>
            </div>
            <div className="col-md-3 col-lg-3 service-item">
              <div className="service-top-svg">
                ...
                <img src="https://www.tallysolution.net/assets/images/7.png" alt="Tally Customization in Delhi India" />
              </div>
            </div>
            <div className="col-md-3 col-lg-3 service-item">
              <div className="service-top-svg">
                ...
                <img src="https://www.tallysolution.net/assets/images/8.png" alt="Tally Customization in Delhi India" />
              </div>
            </div>
